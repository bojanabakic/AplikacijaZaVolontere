 ...
 * @author CJ931WT
 */
public class PotvrdaBrisanjaMackeDijalog extends javax.swing.JDialog {
    Macka macka;
    /**
     * Creates new form PotvrdaBrisanjaMackeDijalog
     */
    public PotvrdaBrisanjaMackeDijalog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        centriraj();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Da li ste sigurni da želite da obrišete mačku?");
    ...
    private void btnDaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDaActionPerformed
        ServerskiTransferObjekat sto = KlijentKontroler.getInstance().obrisiMacku(macka);
        JOptionPane.showMessageDialog(this, sto.getPoruka(), "Informacija", JOptionPane.INFORMATION_MESSAGE);
        ObrisiMackuForma omf = (ObrisiMackuForma) getParent();
        omf.srediModel();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PotvrdaBrisanjaMackeDijalog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PotvrdaBrisanjaMackeDijalog dialog = new PotvrdaBrisanjaMackeDijalog(new javax.swing.JFrame(), true);
